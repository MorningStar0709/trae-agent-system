...
```powershell
npx memlab find-leaks --baseline "C:\Users\skyler\Desktop\heap-baseline.heapsnapshot" --target "C:\Users\skyler\Desktop\heap-target.heapsnapshot" --final "C:\Users\skyler\Desktop\heap-final.heapsnapshot"
```

You can also parse a single snapshot to find the largest objects or explore it individually:

```powershell
npx memlab analyze snapshot --snapshot "C:\Users\skyler\Desktop\heap-target.heapsnapshot"
```
