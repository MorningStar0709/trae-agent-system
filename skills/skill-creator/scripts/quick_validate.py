...
def parse_simple_frontmatter(frontmatter_text):
    """Parse the simple key: value frontmatter Trae Skills require.

    This intentionally avoids external YAML dependencies. It supports the
    scalar frontmatter shape used by Trae Skills and rejects nested structures
    so authors do not accidentally rely on metadata that Trae may not use.
    """
    frontmatter = {}
...
def validate_skill(skill_path):
    ...
    # Parse frontmatter without third-party dependencies.
    try:
